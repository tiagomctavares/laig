...
serialInclude(['../lib/CGF.js', 
    ...
    //LAIGPROB2_inicio
	'./interfaces/AltMaterialInterface.js',
    //LAIGPROB2_fim
...
main=function()
{
    ...
    //LAIGPROB2_inicio
    var altMaterialsInterface = new AltMaterialInterface();
    app.setInterface(altMaterialsInterface);
	
    altMaterialsInterface.setActiveCamera(myScene.camera);

	myScene.setInterface(altMaterialsInterface);
    //LAIGPROB2_fim
